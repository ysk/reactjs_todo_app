...
var CommnetList = React.createClass({displayName: "CommnetList",
  render:function(){
    return(
      React.createElement("div", {className: "commnetList"}, 
...
var CommnetForm = React.createClass({displayName: "CommnetForm",
  render:function(){
    return(
