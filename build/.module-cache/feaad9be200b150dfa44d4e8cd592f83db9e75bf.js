...
var MyTODO = React.createClass({displayName: "MyTODO",
  render:function(){
    return(
      React.createElement("h1", null, "My ODO")
      );
  }
});

React.render(React.createElement(MyTODO, null), document.getElementById('app-container'));